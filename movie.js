...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=7b9529885f475ed49e19c392048e7123&language=en-US&page=1')
...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=7b9529885f475ed49e19c392048e7123&language=en-US&page=2')
.then(response => response.json())
.then(data =>{
    data.results.map((i, j) => {
        if(j > 18)
...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=7b9529885f475ed49e19c392048e7123&language=en-US&page=3')
.then(response => response.json())
.then(data =>{
    data.results.map((i, j) => {
        if(j > 18)
